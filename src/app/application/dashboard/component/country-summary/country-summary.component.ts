...
import { debounceTime, delay, distinctUntilChanged, merge, of, startWith, switchMap, tap } from "rxjs";
...
export class CountrySummaryComponent  implements OnInit {
    ...
    displayedColumns = ['CountryCode', 'Country', 'NewConfirmed', 'TotalConfirmed', 'NewDeaths', 'TotalDeaths', 'NewRecovered', 'TotalRecovered'];
